...
class MainGraphique{
    ...
    public static void main(String[] args){
        // Utiliser le nouveau constructeur avec le mode cheat activé
        Plateau p = new Plateau(true);
        Fenetre f = new Fenetre("Jeu d'échecs - Mode Cheat", 8*MainGraphique.tailleCase, 10*MainGraphique.tailleCase);
